      ...
      <div className="grid md:grid-cols-3 gap-10">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2.5">
            {[
              { icon: Mail,  text: "contato@filtrosbrasil.com.br", href: "mailto:contato@filtrosbrasil.com.br" },
              { icon: Phone, text: "(11) 3183-5020", href: "tel:+551131835020" },
              { icon: MapPin, text: "São Paulo, Brasil", href: "#" },
            ].map(({ icon: Icon, text, href }) => (
              <a key={text} href={href} className="flex items-center gap-2.5 text-sm transition-opacity hover:opacity-100" style={{ color: "rgba(255,255,255,0.6)" }}>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {["Produtos", "Suporte Técnico", "Fale Conosco", "Blog"].map((l) => (
              <a key={l} href="#" className="block text-sm transition-opacity hover:opacity-100" style={{ color: "rgba(255,255,255,0.6)" }}>{l}</a>
            ))}
          </div>
        </div>
      </div>
      <div className="mt-12 pt-6 text-center text-xs" style={{ borderTop: "1px solid rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.35)" }}>
