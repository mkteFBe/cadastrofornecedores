  ...
  <div className="min-h-screen flex items-center justify-center py-16 px-6" style={{ background: "var(--fb-light-gray)" }}>
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="bg-white rounded-lg p-8" style={{ boxShadow: "var(--fb-shadow-floating)", border: "1px solid var(--fb-mid-gray)" }}>
        <h1 className="font-bold uppercase tracking-tight mb-2" style={{ fontSize: "22px", color: "var(--fb-blue)" }}>
        ...
        <Link
          to="/cadastro"
          className="flex items-center justify-center gap-2 w-full py-3.5 text-white font-semibold text-xs uppercase tracking-widest transition-all"
        ...
        {/* Acesso admin discreto — apenas texto pequeno no rodapé do card */}
        <div className="pt-5 mt-5 text-center" style={{ borderTop: "1px solid var(--fb-mid-gray)" }}>
          <p className="text-xs" style={{ color: "var(--fb-slate-gray)" }}>
            Dúvidas? <a href="mailto:compras@filtrosbrasil.com.br" className="font-semibold hover:underline" style={{ color: "var(--fb-blue)" }}>compras@filtrosbrasil.com.br</a>
          </p>
        </div>
      </div>
    </div>
